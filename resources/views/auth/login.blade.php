            ...
            <div class="flex flex-col break-words bg-white border-2 rounded-lg shadow-lg overflow-hidden">
                <form class="" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="px-6 py-8 md:p-10">
                        ...
                        @if (session('status'))
                            <div class="text-sm border-t-8 rounded text-green-700 border-green-600 bg-green-100 px-3 py-4 mt-4"
                                role="alert">
                                {{ session('status') }}
                            </div>
                        @endif
                        ...
                        <div class="mt-8 flex flex-wrap mb-6">
                            ...
                            <input id="username" type="text"
                                class="appearance-none bg-grey-100 rounded w-full p-3 text-grey-700 focus:ring{{ $errors->has('username') ? ' border-red-500' : '' }}"
                        ...
                        <div class="flex flex-wrap justify-between items-center">
                            ...
                            @if (Route::has('password.request'))
                                <a class="whitespace-nowrap no-underline text-sm mt-4"
                    ...
                    <div class="px-6 md:px-10 py-4 bg-grey-50 border-t border-grey-100 flex flex-wrap items-center">
                        <button type="submit"
                            class="bg-cyan-400 w-full hover:bg-cyan-300 text-cyan-900 font-bold py-3 px-4 rounded focus:outline-none ml-auto">
                            {{ __('Login') }}
                        </button>
                    </div>
                </form>
